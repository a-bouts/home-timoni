...
import (
	...
	templates "timoni.sh/home/templates"
)
...
timoni: {
	...
	apply: git_repositories: [ for obj in instance.git_repositories.objects {obj}]
	apply: oci_repositories: [ for obj in instance.oci_repositories.objects {obj}]
	apply: helm_repositories: [ for obj in instance.units.objects if obj.helm_repository != _|_ {obj.helm_repository}]
	apply: kustomizations: [ for obj in instance.units.objects {obj.kustomization}]
}
